...
Once seen as opaque, explainable ML now enables actuaries to improve predictive power whilst maintaining interpretability. Explainable ML can enhance traditional methods, whilst retaining the ability to infuse actuarial judgement. 
...
**IFoA webpage**
TITLE: Breaking down the black box: why actuaries should embrace machine learning now
Desciption: Achieving the best of both worlds with explainable machine learning [H&C: Data Techniques in H&C WP].
